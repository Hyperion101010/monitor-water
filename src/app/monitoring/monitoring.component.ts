...
export class MonitoringComponent implements OnInit {
  ...
  //   'West Bengal': ['Alipurduar','Bankura','Birbhum','Burdwan (Bardhaman)','Cooch Behar','Dakshin Dinajpur (South Dinajpur)','Darjeeling','Hooghly','Howrah','Jalpaiguri','Kalimpong','Kolkata','Malda','Murshidabad',
  //     'Nadia',
  //     'North 24 Parganas',
